...
$wp_customize->add_section(
    ...
    array(
        ...
        'description' => esc_html__("Hero Header is basically a short intro to your visitors", "pureFolio"),
        'priority' => 10,
...
$wp_customize->add_control(
    ...
    array(
        ...
        'description' => __('Change The title of the Hero Header.', 'pureFolio'),
...
$wp_customize->add_control(
    ...
    array(
        ...
        'description' => __('Change The Subtext in the Hero Header.', 'pureFolio'),
...
$wp_customize->add_control(new Clarusmod_Toggle_Switch_Custom_control(
    ...
    array(
        ...
        'description' => __('Disable or Enable The Hero Header Button', 'pureFolio'),
        'section' => 'hero_header_Sec',
...
$wp_customize->add_control(
    ...
    array(
        'label' => __("Change Button Text", 'pureFolio'),
        'description' => __('Change The Text for the Hero Header Button', 'pureFolio'),
