...
$wp_customize->add_section(
    'single_page_excerpt',
    array(
        'title'    => __('Excerpt', 'mts'),
        'description' => __('Disable and Customize the looks of the excerpt on a single Blog page.', 'mts'),
...
$wp_customize->add_control(new Clarusmod_Toggle_Switch_Custom_control(
    ...
    'toggle_single_excerpt',
    array(
        'label' => __('Excerpt', 'mts'),
        'description' => esc_html__('Use this toggle to Disable or Enable the Excerpt on single blog page if you do not want it visible to users.', 'mts'),
...
$wp_customize->add_control(new Clarusmod_Toggle_Switch_Custom_control(
    ...
    'toggle_excerpt_italics',
    array(
        'label' => __('Excerpt Italics', 'mts'),
        'description' => __('Make The Excerpt to be written in Italics', 'mts'),
        'section'  => 'single_page_excerpt',
