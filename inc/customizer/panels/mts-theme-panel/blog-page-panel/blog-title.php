...
$wp_customize->add_section(
    'blog_page_title_sec',
    array(
        'title'    => __('Blog Page Title', 'mts'),
        'description' => esc_html__('Make changes to the title on the blog page, where all you blog post are displayed. Visit the blog page to see your changes reflect there.', 'mts'),
...
$wp_customize->add_control(new Clarusmod_Toggle_Switch_Custom_control(
    ...
    array(
        'label' => __('Title', 'mts'),
        'description' => esc_html__('Use this toggle to Disable or Enable the Title on the blog page.', 'mts'),
...
$wp_customize->add_control(
    ...
    array(
        'label' => __("Title", 'mts'),
        'description' => __('Change The title on the Blog Page.', 'mts'),
