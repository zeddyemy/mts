...
$wp_customize->add_section(
    'blog_page_sidebar',
    array(
        'title'    => __('Blog Page Sidebar', 'mts'),
        'description' => esc_html__('customizer the sidebar on the blog page, where all you blog post are displayed. Visit the blog page to see your changes reflect there.', 'mts'),
...
$wp_customize->add_control(new Clarusmod_Toggle_Switch_Custom_control(
    ...
    array(
        ...
        'description' => esc_html__('Use this toggle to Disable or Enable the Sidebar on the blog page.', 'mts'),
