...
$wp_customize->add_section(
    'folio_hero_header',
    array(
        'title'    => __("Hero Header", "mts"),
        'description' => esc_html__("Customizer the Hero Header of the singular portfolio page.", "mts"),
        'priority' => 10,
...
$wp_customize->add_setting(
    ...
    array(
        'default' => get_mts_assets('img') . 'img3.jpg',
        'transport' => 'refresh',
...
$wp_customize->add_control(new Clarusmod_Toggle_Switch_Custom_control(
    ...
    'toggle_folio_featuredImg',
    array(
        'label' => __('Use Featured Image', 'mts'),
        'description' => esc_html__('If you want, you can use the Featured Image of portfolio as the background image for the Hero Header', 'mts'),
        'section' => 'folio_hero_header',
