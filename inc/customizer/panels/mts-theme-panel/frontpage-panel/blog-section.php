...
$wp_customize->add_section(
    'blog_Sec',
    array(
        'title'    => __("Blog Section", "mts"),
        'description' => esc_html__("Blogs written for your site", 'mts'),
        'priority' => 50,
...
$wp_customize->add_control(new Clarusmod_Toggle_Switch_Custom_control(
    ...
    'toggle_blog_sec',
    array(
        'label' => __('Blog Section', 'mts'),
        'description' => esc_html__('Use The Toggle Button to Disable or Enable the Blog section', 'mts'),
        'section' => 'blog_Sec',
...
$wp_customize->add_setting(
    'blog_sec_title',
    array(
        'default' => __('Our Latest Blogs', 'mts'),
...
$wp_customize->add_control(
    ...
    array(
        'label' => __("Title", 'mts'),
        'description' => __('Change The title of the Blog Section.', 'mts'),
