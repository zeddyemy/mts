<?php
	...
	*************************************/
	...
	$wp_customize->add_setting('mts_theme_color',
		array(
			'default' => '#2869ff',
		)
	);
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			array(
	            'label'      => __( 'Theme Color', 'mts' ), //set the label to appear in the Customizer
		        'section'    => 'base_color_sections', //select the section for it to appear under  
	            'settings'   => 'mts_theme_color', //pick the setting it applies to
				'priority' => 20,
			)
		)
	);